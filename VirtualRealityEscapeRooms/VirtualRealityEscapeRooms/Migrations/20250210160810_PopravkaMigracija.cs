...
{
    /// <inheritdoc />
    public partial class PopravkaMigracija : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PrijavioId = table.Column<int>(type: "int", nullable: false),
                    PrijavljeniId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrijavaKorisnika_Korisnik_PrijavioId",
                        column: x => x.PrijavioId,
                        principalTable: "Korisnik",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PrijavaKorisnika_Korisnik_PrijavljeniId",
                        column: x => x.PrijavljeniId,
                        principalTable: "Korisnik",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rezervacija_Igra_IgraID",
                        column: x => x.IgraID,
                        principalTable: "Igra",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrijavaKorisnika_PrijavioId",
                table: "PrijavaKorisnika",
                column: "PrijavioId");

            migrationBuilder.CreateIndex(
                name: "IX_PrijavaKorisnika_PrijavljeniId",
                table: "PrijavaKorisnika",
                column: "PrijavljeniId");

            migrationBuilder.CreateIndex(
                name: "IX_Rezervacija_IgraID",
                table: "Rezervacija",
                column: "IgraID");
